 ...
 *
 * @param [in] env Environment needs definition
 */
 ...
 * @param[in] passhrase - Used to encrypt options to disk
 ...
 * derivation function on a passphrase.
 *
 * @param[in] passhrase - [Mispelled], Used to encrypt options to disk
 * @param[in] bridge_user - The bridge username
 * @param[in] bridge_pass - The bridge password
 * @param[in] mnemonic - The file encryption mnemonic
 ...
 */
    uint64_t storj_util_timestamp(void);
 ...
 *
 * @param[in] mnemonic - [Needs Definition]
